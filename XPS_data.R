...
# CITATION FOR HOW TO CALCULATE:  https://doi.org/10.1002/sia.6319
...
# THE NEXT LEVEL CORRECTION TO IT, THE RELAXATION ENERGY,
# WOULD REDUCE THE VALUE WHICH LIKELY WOULD REDUCE THE 
# DEVIATION.
